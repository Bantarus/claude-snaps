...
describe('diff — example fixtures', () => {
  test('solo-no-apm: init → final reveals expected change set', () => {
    const init = readSnapshot(SOLO_NO_APM, 'c83bd37ee1409defb1ef0f06c8173618a13ab1d3');
    const finalAuto = readSnapshot(SOLO_NO_APM, '4b4506061fedc71b377b87eb203b692a511d8f52');
